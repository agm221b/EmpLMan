...
$eid=$_SESSION['eid'];
$sql = "SELECT FirstName,LastName,EmpId,available from  tblemployees where id=:eid";
...
<label for="days">No. of days (Available=<?php echo htmlentities(intval($avail));?>)</label>    
<textarea id="textarea1" name="days" class="materialize-textarea" required></textarea>
</div>
<div class="input-field col m12 s12">
