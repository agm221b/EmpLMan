...
if($status=='2')
{
$sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id as pid,tblemployees.Gender,tblleaves.days,tblemployees.Phonenumber,tblemployees.EmailId,tblemployees.available,tblleaves.days,tblleaves.LeaveType,tblleaves.ToDate,tblleaves.FromDate,tblleaves.Description,tblleaves.PostingDate,tblleaves.Status,tblleaves.AdminRemark,tblleaves.AdminRemarkDate from tblleaves join tblemployees on tblleaves.empid=tblemployees.id where tblleaves.id=:did";
$query = $dbh -> prepare($sql);
$query->bindParam(':did',$did,PDO::PARAM_STR);
$query->execute();
...
{         
$d=$result->days; $a=$result->available;
$a=$a+$d; $i=$result->pid;
}}
...
<tr>
					   <td style="font-size:16px;"><b>No. of Leaves Available</b></td>
                                           <td><?php echo htmlentities($result->available);?></td>
                                        </tr>
