            ...
            <main class="mn-inner">
                <div class="row">
                    ...
                    <div class="col s12 m12 l12">
						...
						<th>No. of days</th>
                                            <th width="200">Manager Remark</th>
                                            <th>Status</th>
                                        </tr>
                                    </thead>
...
<?php 
$eid=$_SESSION['eid'];
$sql = "SELECT LeaveType,ToDate,FromDate,Description,PostingDate,days,AdminRemarkDate,AdminRemark,Status from tblleaves where empid=:eid";
