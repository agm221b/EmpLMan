...
<html lang="en">
	...
	<video autoplay muted loop id="myVideo">
	  <source src="assets/images/backgroundvid.mp4" type="video/mp4">
		...
		<li class="no-padding"><a class="waves-effect waves-grey" href="ceo/"><i class="material-icons">account_box</i>CEO Login</a></li>
          ...
          <div class="footer">
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4><i>Welcome to Employee Leave Management System</i></h4></div>
