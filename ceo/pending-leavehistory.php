...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>CEO | Approved Leave leaves </title>
...
<?php 
$status=0;
$sql =  "SELECT tblleaves.id as lid,manager.UserName,manager.d_no,manager.man_id,manager.e_id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Description,tblleaves.AdminRemarkDate,tblleaves.AdminRemark,tblleaves.Status from tblleaves join manager on tblleaves.empid=manager.e_id where tblleaves.Status=:status order by lid desc";
