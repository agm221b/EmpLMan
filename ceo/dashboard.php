                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                ...
                                <span class="card-title">Total Registered Managers</span>
...
$sql = "SELECT man_id from manager";
...
?>   
                ...
                <div class="row">
                    ...
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">CEO Dashboard</span>
...
$sql =  "SELECT tblleaves.id as lid,manager.UserName,manager.d_no,manager.man_id,manager.e_id,manager.d_name,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Description,tblleaves.AdminRemarkDate,tblleaves.AdminRemark,tblleaves.Status from tblleaves join manager on tblleaves.empid=manager.e_id order by lid desc";
$query = $dbh -> prepare($sql);
