     <aside id="slide-out" class="side-nav white fixed">
		...
		<li class="no-padding">
                        <a class="collapsible-header waves-effect waves-grey"><i class="material-icons">account_box</i>Managers<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="addmanager.php">Add Manager</a></li>
                                <li><a href="managemanager.php">Manage Manager</a></li>
