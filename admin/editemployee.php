...
$d_no=$_POST['d_no'];
$sql="update tblemployees set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno,available=:available,d_no=:d_no where id=:eid";
...
<div class="input-field col m6 s12">
<label for="available">Available Leaves</label>
<input id="available" name="available" type="text" value="<?php echo htmlentities($result->available);?>" autocomplete="off" required>
</div>
           
<div class="input-field col m6 s12">
<label for="d_no">Department No.</label>
<input id="d_no" name="d_no" type="text" value="<?php echo htmlentities($result->d_no);?>" autocomplete="off" required>
</div>                                                               
